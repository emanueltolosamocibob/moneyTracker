...
- *Danger* (`.modal-actions button.danger`): `rgba(255,107,107,0.85)` background with dark (`#2a0a0a`) text, not white-on-red — reads as a filled red chip rather than a bright alert. Used only for destructive confirms (Eliminar).
